...
export function getAllVehicles() {
    return (dispatch) => {
        return axios.get("http://localhost:8080/vehicle/all").then(
            resp => {
                dispatch({
                    type: "vehicle/all",
                    payload: resp.data
...
export function createVehicle(payload) {
    return (dispatch) => {
        return axios.post("http://localhost:8080/vehicle/save",payload).then(
            resp => { 
                console.log(resp)
...
export function updateVehicle(payload) {
    return (dispatch) => {
        return axios.put("http://localhost:8080/vehicle/update",payload).then(
            resp => { 
...
export function FetchVehicleById(id) {
    ...
    // const{id} = useParams();
    return (dispatch) => {
        return axios.get("http://localhost:8080/vehicle/find/"+id).then(
            resp =>
             {
                dispatch(
                    {
